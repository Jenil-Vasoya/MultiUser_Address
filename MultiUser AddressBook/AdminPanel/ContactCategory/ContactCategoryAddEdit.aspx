...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <asp:RequiredFieldValidator ID="revContactCategory" ValidationGroup="CountryForm" runat="server" ControlToValidate="txtContactCategoryName" Display="Dynamic" ErrorMessage="*Please enter the Category" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
</div>
    </div>
    <br />
    <hr />
      <div class="row">
            ...
            <div class="offset-5">
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/MultiUser AddressBook/AdminPanel/ContactCategory/ContactCategory.aspx" Text="Cancel" ID="hlCancel" CssClass="btn btn-danger" Width="85px" />
            </div>
