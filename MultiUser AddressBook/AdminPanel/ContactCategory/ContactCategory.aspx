...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12">
     ...
     <div class="row">
    <div class="col-md-2">
        <asp:HyperLink ID="hlAddContactCategory" runat="server"  Text="Add ContactCategory" CssClass="btn btn-outline-dark" NavigateUrl="~/MultiUser AddressBook/AdminPanel/ContactCategory/ContactCategoryAddEdit.aspx"></asp:HyperLink></div>
