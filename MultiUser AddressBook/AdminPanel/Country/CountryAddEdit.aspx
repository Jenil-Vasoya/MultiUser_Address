...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="row">
            ...
            <div class="offset-5">
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/MultiUser AddressBook/AdminPanel/Country/Country.aspx" Text="Cancel" ID="hlCancel" CssClass="btn btn-danger" Width="85px" />
            </div>

        </div>
    <div class="row">
        <div class="text-danger offset-4">
