...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Container box-shadow" style="overflow: hidden; font-family: 'News706 BT'">
        ...
        <div class="row text-center">
            <asp:Label Font-Names="News706 BT" CssClass="text-success" runat="server" ID="lblMessage"></asp:Label>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 offset-4 text-danger">
                <asp:Label runat="server" ForeColor="Red" ID="lblMessageError" EnableViewState="true"></asp:Label>
            </div>
        </div>
