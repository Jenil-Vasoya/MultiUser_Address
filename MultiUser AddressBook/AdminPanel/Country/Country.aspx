...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-2"><asp:HyperLink ID="hlAddCountry" runat="server"  Text="Add Country" CssClass="btn btn-outline-dark btn-align-content-center" NavigateUrl="~/MultiUser AddressBook/AdminPanel/Country/CountryAddEdit.aspx"></asp:HyperLink></div>
                ...
                <asp:TemplateField HeaderText="Delete">
                 ...
                 <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        ...
                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-success" CommandName="EditRecord" NavigateUrl='<%# "~/MultiUser AddressBook/AdminPanel/Country/CountryAddEdit.aspx?CountryID=" +  Eval("CountryID").ToString() %>' />
                    </ItemTemplate>
                </asp:TemplateField>
