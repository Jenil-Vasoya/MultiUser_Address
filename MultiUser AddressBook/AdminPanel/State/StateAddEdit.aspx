        ...
        <div class="row" style="font-family: 'News706 BT';">
            ...
            <div>
                ...
                <div class="text-center">
                    <asp:Label runat="server" ID="lblMessage" CssClass="text-success" EnableViewState="true"></asp:Label>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-danger">
                        <asp:Label runat="server" ID="lblMessageError" EnableViewState="true" ForeColor="Red"></asp:Label>
                    </div>
                </div>
