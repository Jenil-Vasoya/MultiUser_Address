...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Container box-shadow" style="font-family: News706 BT;">
        ...
        <div class="row" style="overflow-x: auto">
            <div class="col-md-2">
                <asp:HyperLink ID="hlAddState" runat="server" Font-Names="News706 BT" Text="Add State" CssClass="btn btn-outline-dark btn-align-content-center" NavigateUrl="~/MultiUser AddressBook/AdminPanel/State/StateAddEdit.aspx"></asp:HyperLink>
            </div>
            <div style="padding-left: 12px">
                <asp:Label ID="lblMessage" Font-Names="News706 BT" runat="server"></asp:Label>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
