...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
    <div class="col-md-2"><asp:HyperLink ID="hlAddContact" runat="server"  Text="Add Contact" CssClass="btn btn-outline-dark" NavigateUrl="~/MultiUser AddressBook/AdminPanel/Contact/ContactAddEdit.aspx"></asp:HyperLink></div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Delete">
                 ...
                 <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-success" NavigateUrl='<%# "~/MultiUser AddressBook/AdminPanel/Contact/ContactAddEdit.aspx?ContactID=" +Eval("ContactID").ToString() %>' />
                    </ItemTemplate>
                </asp:TemplateField>
