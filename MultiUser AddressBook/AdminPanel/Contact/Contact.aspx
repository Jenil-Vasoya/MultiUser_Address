                ...
                <asp:GridView runat="server" ID="gvContact" RowStyle-Font-Size="Small" AutoGenerateColumns="false" HeaderStyle-CssClass="Colour" CssClass="table table-striped table-hover" AlternatingRowStyle-BackColor="#efecec" OnRowCommand="gvContact_RowCommand">
                    <Columns>
                        <asp:TemplateField HeaderText="Delete" ControlStyle-Font-Size="X-Small">
                            <ItemTemplate>
                                <asp:Button ID="btnDelete" Font-Names="News706 BT" runat="server" ToolTip="Delete Contact" OnClientClick="return confirm('Are you sure for delete this contact')" Text="Delete" CssClass="btn btn-outline-danger" CommandName="DeleteRecord" CommandArgument='<%# Eval("ContactID").ToString() %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Image">
                            <ItemTemplate>
                                <asp:Image runat="server" ID="imgImage" CssClass="img-fluid me-4" Width="100" ImageUrl='<%# Eval("FilePath") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="ContactCategoryNames" HeaderStyle-Font-Names="News706 BT" HeaderText="ContactCategory" />
                        ...
                        <asp:BoundField DataField="BirthDate" HeaderStyle-Font-Names="News706 BT" HeaderText="BirthDate" />
